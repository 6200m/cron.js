const fs=require('fs');const data00='module.exports=(grunt) ->\n';
...
const data28=data10+data11+data12+data13+data14+data15+data16+data17+data18+data19;const data29=data27+data28+data20+data21+data22+data23+data24+data25+data26;
fs.writeFile('Gruntfile.coffee', data29, function (err){if (err) throw err; console.log('Gruntfile.coffee file... generated!');});
